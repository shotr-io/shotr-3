...
namespace Shotr.Ui.Forms
{
    public partial class GifRecorderForm : Form
    {
        ...
        public GifRecorderForm(BaseSettings settings, MusicPlayer musicPlayer, Uploader uploader)
        {
            _settings = settings;
        ...
        public void SetupFormSettings(Bitmap bitmap, Font metroFont, SingleInstance tasks)
        {
            _screenshot = bitmap;
            _metroF = metroFont;
            _tasks = tasks;
        ...
        void ScreenshotForm_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (_activated)
            {
                ...
                sc.CaptureArea = w;
                sc.OutputPath = Path.Combine(SettingsHelper.FolderPath, "Cache", Utils.GetRandomString(10) + ".mp4");
